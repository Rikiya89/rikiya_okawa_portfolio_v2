...
>
    ...
    >
        こんにちは。大川力也です。WebエンジニアとしてHTML/CSS/JavaScript/Node.jsを用いた制作に携わり、個人制作ではReact/Next.jsにも取り組んでいます。パフォーマンスとUXの両立を追求し、体験価値の高いWebを設計・実装することが強みです。神田外語学院卒業後、グロスモントカレッジでデジタルアートの学位を取得。帰国後はコストコホールセール、アコーホテルズでの勤務を経て、デジタルハリウッド東京でUI/UXデザインを専攻しました。
    </motion.p>
    <motion.a
        href="/about-me_jp"
