...
Integrated the Udemy API to display course info in articles and set up an Nginx reverse proxy for stable routing and delivery.`,
  ...
  },
  {
    ...
    description: `Created Kikkoman recipe and campaign landing pages.\nDeveloped warm, easy-to-follow layouts that support every step.\n\nTechnologies\nHTML / SCSS / JavaScript / Node.js / Gulp\n\nRole\nFront-End Engineering (Maintenance & Landing Page Production)`,
  ...
  },
  {
    ...
    description: `Supported Dickies Japan operations.\nDelivered responsive landing pages for new product drops and campaign announcements.\n\nTechnologies\nHTML / SCSS / JavaScript / Node.js / Gulp\n\nRole\nFront-End Engineering (Maintenance & Landing Page Production)`,
